...
cat('<iframe src="./assets/widgets/dt.html" width=100% height=100% allowtransparency="true"> </iframe>')
```
...
```{r, echo=FALSE, warning=F,cache=FALSE,results='asis',message = F}
...
```{r, echo=FALSE, , fig.height = 3.5, fig.width = 12, fig.align = 'center',warning=F,cache=FALSE,results='asis',message = F}
...
```{r, echo=FALSE, ,fig.height = 4, fig.width = 12, fig.align = 'center',warning=F,cache=FALSE,results='asis',message = F}
library(ggplot2)
...
```{r, echo=FALSE, warning=F, fig.height = 4, fig.width = 12, fig.align = 'center',cache=FALSE,results='asis',message = F}
library(ggplot2)
...
```{r, echo=FALSE, warning=F,, fig.height = 4.5, fig.width = 8, fig.align = 'center',cache=FALSE,results='asis',message = F}
library(DataExplorer)
...
```{r, echo=FALSE, warning=F, fig.height = 3, fig.width = 12, fig.align = 'center',cache=FALSE,results='asis',message = F}
library(ggplot2)
...
```{r warning=FALSE, collapse=TRUE,size = 'tiny'}
data %>%
...
data=data %>%select(-ward, - subvillage,- wpt_name )

data=data %>%select(-date_recorded )

data=data %>%select(-lga )
data=data %>%select(-installer,-funder )
```
...
```{r, echo=FALSE, warning=F, fig.height = 4, fig.width = 10, fig.align = 'center',cache=FALSE,results='asis',message = F}
library(dplyr)
